...
class Student {
    ...
    pay_fees(amount) {
        this.balance -= amount;
        console.log(chalk.bgBlueBright(`$${amount} Fees paid successfully for ${this.name}`));
...
class Student_manager {
    ...
    add_student(name) {
        ...
        console.log(chalk.yellowBright(`Student: ${name} added successfully. Student ID: ${student.id}`));
    }
    ...
    view_student_balance(student_id) {
        ...
        if (student) {
            ...
            console.log(chalk.bgYellowBright("Student not found. please enter a correct student ID"));
        }
    }
    // method to pay for student fees
...
async function main() {
    console.log(chalk.greenBright("welcome to Haroon Afridi - Student Managemet System "));
